  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            MessageCreater(title: 'Davomat xabari', keyOnBox: "attendance_text",text: "Farzandingiz #ismi #fam  #fan #guruh darsiga kelmadi . #sana", ),
            SizedBox(height: 8,),
            MessageCreater(title: 'Imtihon xabari', keyOnBox: "exam_text",text: "Farzandingiz #ismi #fam #fan #guruh imtihonidan #foiz oldi . #sana", ),
...
// HelperWidget
 class MessageCreater extends StatelessWidget {
  ...
  final String text;
  GetStorage box = GetStorage();
  MessageCreater({required this.title,  required this.keyOnBox, required this.text});
         ...
         child: ListTile(
           ...
           trailing: IconButton(onPressed: (){
             if(box.read(keyOnBox) == null){
               ...
               editingController = TextEditingController(text: box.read(keyOnBox));
                     ...
                     child: Container(
                       ...
                       child: Column(
                         ...
                         children: [
                           ...
                           InkWell(
                             onTap: () {
                               box.write(keyOnBox, "${editingController.text}");
