...
import 'package:leader/screens/admin/addtional_screens/block_screen.dart';
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
            ...
            appBar: AppBar(
              actions: [
                Row(
                  children: [
                    IconButton(
                        onPressed: () {
                          changeDateByOneDay2(studentController.selectedStudyDate,increase: false);
                        },
                        icon: Icon(
                    ...
                    IconButton(
                        onPressed: () {
                          changeDateByOneDay2(studentController.selectedStudyDate,increase: true);
                        },
                        icon: Icon(
              ...
              title: Text(
                "${widget.groupName} ",
                style: appBarStyle.copyWith(color: Colors.white, fontSize: 12),
              ),
              bottom: TabBar(
